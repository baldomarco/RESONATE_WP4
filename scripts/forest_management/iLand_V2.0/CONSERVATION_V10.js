...
var planting_1_cns = {
	 type: "planting", 
	 schedule: 2 ,    
	 items: [ {species: "qupe",  height: 0.5, fraction: 0.6 , clear: false},
		  {species: "tico",  height: 0.5, fraction: 0.2 	},
		  {species: "cabe",  height: 0.5, fraction: 0.1 	},
		  {species: "acpl",  height: 0.5, fraction: 0.1 	}],
		  
// Here just doing logging to logfile:
	 onExit: function() { 	fmengine.log("Planting qupe fraction= 0.6" );
    			     	    fmengine.log("Planting tico fraction= 0.2" );
                            fmengine.log("Planting cabe fraction= 0.1" );
                            fmengine.log("Planting acpl fraction= 0.1" );}
};
...
var planting_3_cns = {
	 ...
	 items: [ {species: "qupe",  height: 0.5, fraction: 0.4 , clear: false},
		      {species: "fasy",  height: 0.5, fraction: 0.3 	},
			  {species: "abal",  height: 0.5, fraction: 0.2 	},
			  {species: "acps",  height: 0.5, fraction: 0.1 	}],
		  
// Here just doing logging to logfile:
	 onExit: function() { 	fmengine.log("Planting qupe fraction= 0.4" );
    			     	    fmengine.log("Planting fasy fraction= 0.3" );
                            fmengine.log("Planting abal fraction= 0.2" );
                            fmengine.log("Planting acps fraction= 0.1" );}
};
...
var planting_5_cns = {
	 ...
	 items: [ {species: "qupe",  height: 0.5, fraction: 0.4 , clear: false},
			  ...
			  {species: "abal",  height: 0.5, fraction: 0.2 	},
			  {species: "acps",  height: 0.5, fraction: 0.1 	},
			  {species: "tipl",  height: 0.5, fraction: 0.1 	}],
...
// Here just doing logging to logfile:
	 onExit: function() { 	fmengine.log("Planting qupe fraction= 0.4" );
                            ...
                            fmengine.log("Planting abal fraction= 0.2" );
                            fmengine.log("Planting acps fraction= 0.1" );
							fmengine.log("Planting tipl fraction= 0.1" );}
};
...
var planting_7a_cns = {
	 ...
	 items: [ {species: "qupe",  height: 0.5, fraction: 0.4 , clear: false},
			  ...
			  {species: "quro",  height: 0.5, fraction: 0.2 	},
			  {species: "acps",  height: 0.5, fraction: 0.1 	}],
		  
// Here just doing logging to logfile:
	 onExit: function() { 	fmengine.log("Planting qupe fraction= 0.4" );
    			     	    fmengine.log("Planting abal fraction= 0.3" );
                            fmengine.log("Planting quro fraction= 0.2" );
                            fmengine.log("Planting acps fraction= 0.1" );}
};
...
var planting_7b_cns = {
	 ...
	 items: [ {species: "quro",  height: 0.5, fraction: 0.4 , clear: false},
			  {species: "frex",  height: 0.5, fraction: 0.3 	},
			  {species: "algl",  height: 0.5, fraction: 0.2 	},
			  {species: "ulgl",  height: 0.5, fraction: 0.1 	}],
		  
// Here just doing logging to logfile:
	 onExit: function() { 	fmengine.log("Planting quro fraction= 0.4" );
    			     	    fmengine.log("Planting frex fraction= 0.3" );
                            fmengine.log("Planting algl fraction= 0.2" );
                            fmengine.log("Planting ulgl fraction= 0.1" );}
};
...
var finalcut = {
  ...
  schedule: { minRel: 0.99, optRel: 1.0, maxRel: 1.01, force: true },
  onEvaluate: function() {
    stand.trees.load('dbh<30');
	stand.trees.filter("dbh>5");
    stand.trees.filter("age>0");
    stand.trees.harvest();
    fmengine.log("finalHarvest:" + stand.activity.finalHarvest);
    let nlarge = stand.trees.load('dbh>=30');
    stand.trees.randomize();
    stand.trees.filter('incsum(1) < ' + (nlarge - 10)); // Corrected the parentheses // if you have 100 trees >30, this would be then: incsum(1)<90 -> 10 trees would be excluded from filtering
    stand.trees.filter("dbh>5");
    stand.trees.filter("age>0");
	fmengine.log("finLcut: using age threshold: " + stand.U * 0);
    fmengine.log("Number of trees after selecting: " + stand.trees.count);
    stand.trees.harvest();
    return true;
  },
  onExecute: function() {
...
var stp2_sw = { U: [140,140,140], // short/normal/long rotation age --- are ignored if U is provided in input file  ... we have it in .csv
            options: {}, 
			planting_3_cns:  planting_3_cns, 
...
var stp3_sw = { U: [140,140,140], // short/normal/long rotation age --- are ignored if U is provided in input file  ... we have it in .csv
            options: {}, 
			planting_5_cns:  planting_5_cns, 
			salvager_sw: salvager_sw,
...
var stp4_sw = { U: [140,140,140], // short/normal/long rotation age --- are ignored if U is provided in input file  ... we have it in .csv
            options: {}, 
			planting_7a_cns:  planting_7a_cns, 
			salvager_sw: salvager_sw,
...
var stp5_sw = { U: [140,140,140], // short/normal/long rotation age --- are ignored if U is provided in input file  ... we have it in .csv
            options: {},
            // standmonitoring: stand_monitor
