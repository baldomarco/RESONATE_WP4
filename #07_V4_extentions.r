...
pdf(paste0(dataroot, "20240822_Combined_GAM_Spline_Residual_Plots.pdf"), height = 16, width = 24)
...
# Open a PDF device to save all plots
pdf(paste0(dataroot, "20240823_Combined_GAM_Spline_Residual_Plots.pdf"))
